...
| Windows, Android, web CI | Green on commit `a30ae156084a051182f44c465365838030b13028`; Android build/lint/JVM tests, Windows build/tests, and website release validation passed. | [Push CI](https://github.com/ryanspice/pocketmic-lan/actions/runs/36092864661), [PR CI](https://github.com/ryanspice/pocketmic-lan/actions/runs/36092870480), and [PR Lighthouse](https://github.com/ryanspice/pocketmic-lan/actions/runs/36092870476). Build artifact metadata is recorded in [`BUILD-EVIDENCE.md`](BUILD-EVIDENCE.md). |
| iOS | Simulator app builds on `a30ae15`; package contains 38-string `en-US`, `ckb`, and `ku-Latn` UI catalogs plus localized microphone and local-network purpose strings. The app remains an experimental PCM v1 publisher. | [Push iOS CI](https://github.com/ryanspice/pocketmic-lan/actions/runs/36092864535) and [PR iOS CI](https://github.com/ryanspice/pocketmic-lan/actions/runs/36092870486) passed, including bundle verification. Downloaded artifact metadata is in [`BUILD-EVIDENCE.md`](BUILD-EVIDENCE.md). No physical iPhone-to-receiver acceptance is recorded. |
| macOS | Hosted CI built the unsigned universal app and CoreAudio virtual-microphone driver, with seven passing XCTest cases. The packaged app has the English/Kurdish UI catalogs and localized local-network purpose text. | [Push macOS CI](https://github.com/ryanspice/pocketmic-lan/actions/runs/36092864551) and [PR macOS CI](https://github.com/ryanspice/pocketmic-lan/actions/runs/36092870474) passed, including bundle verification and driver packaging. Artifact metadata is in [`BUILD-EVIDENCE.md`](BUILD-EVIDENCE.md). This remains build/protocol-test/package evidence, not driver installation or live routing acceptance. |
