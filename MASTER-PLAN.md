...
| Windows, Android, web CI | Green on commit `60beb91f2e50c56938d0ac6601eac51f3e51c234`; Android build/lint/JVM tests, Windows build/tests, and website release validation passed. | [Push CI](https://github.com/ryanspice/pocketmic-lan/actions/runs/36087784416) and [PR CI](https://github.com/ryanspice/pocketmic-lan/actions/runs/36087786644). Build artifact names, digests, and expiry are recorded in [`BUILD-EVIDENCE.md`](BUILD-EVIDENCE.md). |
| iOS | Simulator build passes on commit `60beb91`; the app remains an experimental PCM v1 publisher. | [Push iOS CI run](https://github.com/ryanspice/pocketmic-lan/actions/runs/36087784547) and [PR iOS run](https://github.com/ryanspice/pocketmic-lan/actions/runs/36087786648) passed. No physical iPhone-to-receiver acceptance is recorded. |
| macOS | Hosted CI built the unsigned universal app and CoreAudio virtual-microphone driver, with seven passing XCTest cases for sequence ordering/rollover and shared PCM AES-GCM fixture acceptance/rejection, on commit `60beb91`. | [Push macOS CI run](https://github.com/ryanspice/pocketmic-lan/actions/runs/36087784405) and [PR macOS CI run](https://github.com/ryanspice/pocketmic-lan/actions/runs/36087786689) passed and uploaded the tester preview (artifact digest and expiry in [`BUILD-EVIDENCE.md`](BUILD-EVIDENCE.md)). This remains build/protocol-test/package evidence, not driver installation or live routing acceptance. |
