...
| Windows release package | Hosted Windows CI builds the x64 receiver with pinned Opus 1.5.2, runs the full test suite including native Opus smoke coverage, validates third-party notices, and uploads a self-contained ZIP. | Current [manual-test preview](https://github.com/ryanspice/pocketmic-lan/actions/runs/36110890990/artifacts/10853391723) is a GitHub artifact archive of 68,184,812 bytes with digest `sha256:b6126f45641b1bf3baa5f5b0e22228269b2e02b1e66a5b39ea7c94e8ebebf857`; this digest covers the outer workflow artifact, not the ZIP extracted from it. It is an unsigned development preview, not a tagged release or physical Windows acceptance. |
