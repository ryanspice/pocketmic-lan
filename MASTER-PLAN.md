...
| Windows, Android, web CI | Green on Android implementation commit `ff690fc`; the subsequent documentation-only commit's CI also passed. | [Implementation push CI](https://github.com/ryanspice/pocketmic-lan/actions/runs/36079402684) includes Android build/lint/unit tests and Windows build/tests; [documentation push CI](https://github.com/ryanspice/pocketmic-lan/actions/runs/36079725168) validates the release-site consistency check too. |
| iOS | Simulator build passes on the latest implementation; the app remains an experimental PCM v1 publisher. | [Push iOS CI run](https://github.com/ryanspice/pocketmic-lan/actions/runs/36079402514). No physical iPhone-to-receiver acceptance is recorded. |
| macOS | Hosted CI builds unsigned universal app and CoreAudio virtual-microphone driver artifacts. | [Push macOS CI run](https://github.com/ryanspice/pocketmic-lan/actions/runs/36079402704). This is build/package evidence only, not driver installation or live routing acceptance. |
