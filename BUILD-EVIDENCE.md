...
## v0.1.6 site locale preview and hosted build (2026-09-25)

- Commit `7e29ad5c6c74af95c44f59371a2ceaac5980c04a` adds the core-site English locale preference preview and catalog status. On that exact commit, Android/Windows/web CI [run 36109248141](https://github.com/ryanspice/pocketmic-lan/actions/runs/36109248141), Lighthouse [run 36109248130](https://github.com/ryanspice/pocketmic-lan/actions/runs/36109248130), macOS [run 36109248148](https://github.com/ryanspice/pocketmic-lan/actions/runs/36109248148), and iOS [run 36109248138](https://github.com/ryanspice/pocketmic-lan/actions/runs/36109248138) all completed successfully.
- Hosted preview artifacts: Windows self-contained receiver ZIP, 68,190,373 bytes, GitHub artifact digest `sha256:29275eee4dda54a3f911227be0ce3227cd51ad26b9e51f190159490dfd69545a`, [artifact 10852725501](https://github.com/ryanspice/pocketmic-lan/actions/runs/36109248141/artifacts/10852725501); Android debug APK, 23,495,841 bytes, artifact digest `sha256:b32ee0a3e248bad2900296fa1fa362584d0caca5e9f69fb1cbcae619277d5690`, [artifact 10852353569](https://github.com/ryanspice/pocketmic-lan/actions/runs/36109248141/artifacts/10852353569); unsigned universal macOS app/virtual-mic preview package, 489,964 bytes, artifact digest `sha256:dcf84018d0ff1163d7f22837d71795e340fa17c2f2784554afb37083b53201a5`, [artifact 10852496638](https://github.com/ryanspice/pocketmic-lan/actions/runs/36109248148/artifacts/10852496638); iOS Simulator app, 5,837,009 bytes, artifact digest `sha256:d36d350765d962c3bd2714ee5893aef71fadbdac6a45167c8b70470fe6c08eb9`, [artifact 10852811063](https://github.com/ryanspice/pocketmic-lan/actions/runs/36109248138/artifacts/10852811063). These are GitHub artifact-archive digests, not checksums of files extracted from each archive.
- All are expiring CI previews, not v0.1.6 release assets. The macOS archive is unsigned; no device-level install, virtual-input registration, or phone-to-destination audio acceptance is established by these runs.

### Manual-test preparation build (`700b245c0ab5e0d6459838389534f24f1b553150`)

- The Mac tester guide now explicitly prohibits physical packet mutation/replay tests; CI fixtures remain the evidence for tamper rejection. Android/Windows/web CI [run 36110890990](https://github.com/ryanspice/pocketmic-lan/actions/runs/36110890990), Lighthouse [run 36110890942](https://github.com/ryanspice/pocketmic-lan/actions/runs/36110890942), macOS [run 36110890967](https://github.com/ryanspice/pocketmic-lan/actions/runs/36110890967), and iOS [run 36110890947](https://github.com/ryanspice/pocketmic-lan/actions/runs/36110890947) all passed on the exact commit.
- Current manual-test artifacts: Windows, 68,184,812 bytes, GitHub artifact digest `sha256:b6126f45641b1bf3baa5f5b0e22228269b2e02b1e66a5b39ea7c94e8ebebf857`, [artifact 10853391723](https://github.com/ryanspice/pocketmic-lan/actions/runs/36110890990/artifacts/10853391723); Android debug APK, 23,495,842 bytes, digest `sha256:c5a2ab57a8666dbf93adc69a18375072026042ecca0fc06d4ece5dabb88d88a5`, [artifact 10852664676](https://github.com/ryanspice/pocketmic-lan/actions/runs/36110890990/artifacts/10852664676); unsigned macOS preview, 489,998 bytes, digest `sha256:ea79b9878ef7dfddd5e74e2d31205a1da9a701f6c2d4c7b932b286ad7f98af60`, [artifact 10852922653](https://github.com/ryanspice/pocketmic-lan/actions/runs/36110890967/artifacts/10852922653); iOS Simulator app, 5,837,009 bytes, digest `sha256:2c66d936ff08a67b45bc520f77a8926360b50b3a6724057d48f3deb50ededc2d`, [artifact 10853161916](https://github.com/ryanspice/pocketmic-lan/actions/runs/36110890947/artifacts/10853161916). These digests identify the GitHub artifact ZIP archives, not the files inside them.
- See [`MANUAL-TESTING-0.1.6.md`](MANUAL-TESTING-0.1.6.md) for the Windows/Android, desktop-control, Mac-driver, and locale acceptance matrix. The iOS artifact is simulator-only and cannot be installed on a physical iPhone.

## Android shared protocol-vector coverage (2026-09-25)

- Added Android JVM coverage that emits both PCM v1 and Opus v2 packets and compares the complete datagrams byte-for-byte with the repository's shared protocol vectors. The vectors are generated by `tests/gen_vectors.py`; its Android `.properties` companion is derived from the same key, nonce, headers, payloads, and ciphertext/tag values used by the canonical JSON file consumed by Windows and macOS tests.
- The source generator parses successfully, and a local parity check confirmed each Android companion field matches `tests/fixtures/vectors.json`. Local Android JVM execution was unavailable because the Gradle wrapper distribution was not cached and network access to `services.gradle.org` is blocked in this environment.
- Hosted push CI passed on code commit `53c6896ff0919b747b65dd50d60fa8981511768b`: primary Android/Windows/web [run 36102992412](https://github.com/ryanspice/pocketmic-lan/actions/runs/36102992412), iOS [run 36102992396](https://github.com/ryanspice/pocketmic-lan/actions/runs/36102992396), and macOS [run 36102992418](https://github.com/ryanspice/pocketmic-lan/actions/runs/36102992418). Associated PR checks passed: primary [run 36102997877](https://github.com/ryanspice/pocketmic-lan/actions/runs/36102997877), iOS [run 36102997923](https://github.com/ryanspice/pocketmic-lan/actions/runs/36102997923), macOS [run 36102997783](https://github.com/ryanspice/pocketmic-lan/actions/runs/36102997783), and Lighthouse [run 36102997805](https://github.com/ryanspice/pocketmic-lan/actions/runs/36102997805).
- These tests establish deterministic packet-format and AES-GCM agreement for the covered vectors. They do not prove real audio delivery, physical device compatibility, or Opus decoding by the Mac receiver.

### iOS sender vector test (commit `abafbb2e4016c7a7d457a283c1fcf030f2c75e02`)

- Added an iOS unit-test target that loads the canonical JSON vectors and verifies iOS pairing-key derivation and PCM v1 packet emission byte-for-byte. GitHub Actions now runs this test on an available iPhone Simulator before uploading the simulator app.
- Hosted push checks passed: primary Android/Windows/web [run 36103734743](https://github.com/ryanspice/pocketmic-lan/actions/runs/36103734743), iOS simulator build and vector test [run 36103734602](https://github.com/ryanspice/pocketmic-lan/actions/runs/36103734602), and macOS [run 36103734582](https://github.com/ryanspice/pocketmic-lan/actions/runs/36103734582). Pull-request checks passed: primary [run 36103741515](https://github.com/ryanspice/pocketmic-lan/actions/runs/36103741515), iOS [run 36103741352](https://github.com/ryanspice/pocketmic-lan/actions/runs/36103741352), macOS [run 36103741296](https://github.com/ryanspice/pocketmic-lan/actions/runs/36103741296), and Lighthouse [run 36103741232](https://github.com/ryanspice/pocketmic-lan/actions/runs/36103741232).
- This remains simulator/protocol evidence. Physical iPhone microphone capture and receiver audio routing remain unverified.
...
## Previous application previews before selected-site integration (2026-09-25)

- PR candidate `76d7ce72905b59be89045e3d98cb05b7cc7bf91e` passed the latest Windows/Android/web CI [run 36112980901](https://github.com/ryanspice/pocketmic-lan/actions/runs/36112980901), Lighthouse [run 36112980930](https://github.com/ryanspice/pocketmic-lan/actions/runs/36112980930), iOS [run 36112980929](https://github.com/ryanspice/pocketmic-lan/actions/runs/36112980929), and macOS [run 36112980945](https://github.com/ryanspice/pocketmic-lan/actions/runs/36112980945). Windows build/full tests/package, Android debug APK/lint/JVM tests, web validation, iOS simulator protocol test and bundle check, and macOS protocol/build/package verification passed.
- Windows preview artifact `pocketmic-receiver-win-x64` is 68,185,440 bytes with Actions artifact digest `62a0fd81da9588fdf13e4615ef6ceadbdfa1b3faba0ada56c65d865c92b18651`; expires 2026-10-25. Android debug APK artifact `pocketmic-debug-apk` is 23,495,843 bytes with Actions artifact digest `a8f6a71b472f06ae9990ce4229d7c14c6552c51b2dd197da421476cf22fd1935`; expires 2026-10-09.
- Unsigned macOS preview `pocketmic-macos-preview-8b2455cefd42fa244c3ce26af0a85d499000da42` is 490,017 bytes with Actions artifact digest `e16f4d9662af6ba38e5908f7127d24efca0a74f36c524061d7f6de19fbf98015`; expires 2026-10-25. iOS simulator artifact `pocketmic-ios-simulator-8b2455cefd42fa244c3ce26af0a85d499000da42` is 5,837,009 bytes with Actions artifact digest `70ca86d661c105465c549994e6edf1c41f5e61ed5ae160dd628da21140103b01`; expires 2026-10-09.
- These are untagged previews; they do not prove physical-device/audio acceptance. This candidate predates integration of the selected marketing-site replacement from [Replace marketing site](codex://threads/01a0d5b9-83f5-7dc2-8fde-958d75ac661c), so these CI/Lighthouse runs do not validate that site payload. Fresh runs for the integrated candidate are recorded below.

## Selected marketing site and v0.1.6 manual-test candidate (2026-09-25)

- Candidate commit `58366868b4fb6c511ef40caa385b084ea76483f2` integrates the selected homepage into canonical `dev/v3/`, targets that payload in CI and Lighthouse, and corrects the local Signal Lab mute message so it does not imply a remote receiver connection.
- Local verification passed: syntax checks for the three site scripts, `scripts/validate-site-release.mjs` (16 registered routes, local links/hooks, locale defaults and v0.1.5 download facts), and `git diff --check`. I also visually reviewed the 1280 px homepage and setup illustration and exercised the generated local sample/mute flow without granting microphone permission.
- All hosted jobs passed: [primary CI](https://github.com/ryanspice/pocketmic-lan/actions/runs/36146161097) (Windows build, full tests and package; Android debug APK, lint and `testDebugUnitTest`; website validation and preview upload), [iOS](https://github.com/ryanspice/pocketmic-lan/actions/runs/36146161174) (simulator build, shared protocol-vector test and bundle validation), [macOS](https://github.com/ryanspice/pocketmic-lan/actions/runs/36146161353) (protocol tests, universal app/driver build and package verification), and [Lighthouse](https://github.com/ryanspice/pocketmic-lan/actions/runs/36146161065) (canonical `dev/v3/`).
- The website preview is [artifact 10869835828](https://github.com/ryanspice/pocketmic-lan/actions/runs/36146161097/artifacts/10869835828), 2,195,765 bytes, digest `sha256:833b5c98140cb8cc80998915e4bbe949fc655fe92cadc756c65b596e58698aef`, expiring 2026-10-25.
- The Windows receiver is [artifact 10870335436](https://github.com/ryanspice/pocketmic-lan/actions/runs/36146161097/artifacts/10870335436), 68,185,044 bytes, digest `sha256:343b7acd06ce8f3a48783713bd1b8774883f2928eba760666654b1d363101169`, expiring 2026-10-25. This is an unsigned development preview.
- The Android debug APK is [artifact 10870031221](https://github.com/ryanspice/pocketmic-lan/actions/runs/36146161097/artifacts/10870031221), 23,495,840 bytes, digest `sha256:2d5273d7f9410ee98bd8832df4f170df552aaebf18ee494a76558864e0bafba2`, expiring 2026-10-09. It is debug-signed and installs separately from v0.1.5.
- The unsigned macOS tester package is [artifact 10869750677](https://github.com/ryanspice/pocketmic-lan/actions/runs/36146161353/artifacts/10869750677), 490,000 bytes, digest `sha256:d64747794caaa27643f03c594a2175514de03061449c3f18f9ebaef4d158c62e`, expiring 2026-10-25.
- The iOS simulator app is [artifact 10869596500](https://github.com/ryanspice/pocketmic-lan/actions/runs/36146161174/artifacts/10869596500), 5,837,009 bytes, digest `sha256:8505efe71a2878036dec1aabd644e0e1b60de9d158bc12ee112bcf697b74d576`, expiring 2026-10-09. It is not a physical-device IPA.
- Artifact digests identify the outer GitHub Actions ZIP. Manual install, physical-device interoperability, site visual/accessibility review, and release acceptance remain open; these untagged artifacts are not v0.1.6 release downloads.
